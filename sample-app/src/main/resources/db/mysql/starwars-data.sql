...
INSERT IGNORE INTO starwars.character (species, id, name, height, mass, metadata) values
...
INSERT IGNORE INTO starwars.starship (id, name, length, pilot_id) values
...
INSERT IGNORE INTO starwars.character_episode_link (character_id, episode_id) values
(1000, 'NEWHOPE'),
(1000, 'EMPIRE'),
(1000, 'JEDI'),
(1001, 'NEWHOPE'),
...
INSERT IGNORE INTO starwars.character_friend_link (character_id, friend_id)
values
(1000, 1002),
(1000, 1003),
(1000, 2000),
